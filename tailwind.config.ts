  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'home-hero1': "url('/images/home-hero1.webp')",
        'home-hero1-sm': "url('/images/home-hero1-sm.webp')",
        'home-hero2': "url('/images/home-hero2.webp')",
        'home-hero2-sm': "url('/images/home-hero2-sm.webp')",
        'home-hero3': "url('/images/home-hero3.webp')",
        'home-hero3-sm': "url('/images/home-hero3-sm.webp')"
      },
      animation: {
        'tansition-1-3': 'tansition-1-3 16s infinite ease',
        'tansition-2-3': 'tansition-2-3 16s infinite ease',
        'tansition-3-3': 'tansition-3-3 16s infinite ease'
      },
      keyframes: {
        'tansition-1-3': {
          '0%': {
